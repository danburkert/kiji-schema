...
public class TestCassandraKijiResult extends CassandraKijiClientTest {
  ...
  @Before
  public void setupTestCassandraKijiResult() throws IOException {
  ...
  @After
  public void cleanupTestCassandraKijiRowView() throws IOException {
    mTable.release();
    mReader.close();
  }
