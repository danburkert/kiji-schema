...
public final class TestingCassandraFactory implements CassandraFactory {
   ...
   * @throws java.io.IOException on I/O error when creating the mini cluster.
   */
   ...
   * ZooKeeperClients.
   *
   * @throws java.io.IOException in case of an error creating the temporary directory or starting
   *     the mini zookeeper cluster.
   */
