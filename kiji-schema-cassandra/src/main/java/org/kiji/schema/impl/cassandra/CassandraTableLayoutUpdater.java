 ...
 * </p>
 */
public class CassandraTableLayoutUpdater {
  private static final Logger LOG = LoggerFactory.getLogger(CassandraTableLayoutUpdater.class);
   ...
   */
  public CassandraTableLayoutUpdater(
  ...
  public void update() throws IOException, KeeperException {
    ...
    try {
      ...
      final KijiTableLayout updatedLayout = KijiTableLayout.createUpdatedLayout(update , currentLayout);
