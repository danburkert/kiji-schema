...
public class TestShortColumnNameTranslator {
  ...
  public void testTranslateFromKijiToHBase() throws Exception {
    HBaseColumnName infoName = mTranslator.toHBaseColumnName(new KijiColumnName("info:name"));
    assertEquals("B", infoName.getFamilyAsString());
    assertEquals("B:B", infoName.getQualifierAsString());

    HBaseColumnName infoEmail = mTranslator.toHBaseColumnName(new KijiColumnName("info:email"));
    ...
    HBaseColumnName purchases = mTranslator.toHBaseColumnName(new KijiColumnName("purchases:foo"));
  ...
  public void testNoSuchHBaseColumn() throws Exception {
    mTranslator.toHBaseColumnName(new KijiColumnName("doesnt:exist"));
  }
