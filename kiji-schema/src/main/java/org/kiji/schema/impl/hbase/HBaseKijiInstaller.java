...
public final class HBaseKijiInstaller implements KijiInstallerProvider {
  ...
  public void install(KijiURI uri, Map<String, String> properties) throws IOException {
    install(uri, HBaseFactory.Provider.get(), properties, HBaseConfiguration.create());
  }
  ...
  public void uninstall(KijiURI uri) throws IOException {
    uninstall(uri, HBaseConfiguration.create());
  }
