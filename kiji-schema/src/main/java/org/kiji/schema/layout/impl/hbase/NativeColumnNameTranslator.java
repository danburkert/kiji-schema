 ...
 */
@ApiAudience.Private
public final class NativeColumnNameTranslator extends HBaseColumnNameTranslator {
  private static final Logger LOG = LoggerFactory.getLogger(NativeColumnNameTranslator.class);

  /** The table to translate names for. */
  private final KijiTableLayout mLayout;

  /**
   * Creates a new {@link NativeColumnNameTranslator} instance.
   *
   * @param layout The layout of the table to translate column names for.
   */
  public NativeColumnNameTranslator(KijiTableLayout layout) {
    mLayout = layout;
