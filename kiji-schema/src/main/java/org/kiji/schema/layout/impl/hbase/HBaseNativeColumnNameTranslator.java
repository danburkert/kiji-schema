 ...
 * {@inheritDoc}
 *
 * <p> The native mapping uses the Kiji family as the translated column family and the Kiji
 * qualifier as the translated qualifier. The Kiji locality groups *must* match the Kiji column
 * family exactly; therefore only one Kiji column family per locality group is permitted. </p>
 *
 * <p> This class is for the purpose of reading native HBase tables whose HBase family/qualifiers do
 * not use the notion of locality groups. </p>
 */
@ApiAudience.Private
public final class HBaseNativeColumnNameTranslator extends KijiColumnNameTranslator {
  ...
  /** {@inheritDoc}. */
  @Override
  public KijiColumnName toKijiColumnName(TranslatedColumnName hbaseColumnName)
      throws NoSuchColumnException {
    LOG.debug("Translating column name '{}' to Kiji column name.", hbaseColumnName);
