...
/**
 *
 * TODO: Update Cassandra column name translators with identity, native.
 */
public abstract class CassandraColumnNameTranslator {
  ...
  /**
   * Creates a new <code>KijiColumnNameTranslator</code> instance.  Supports either the
   * {@link org.kiji.schema.layout.impl.cassandra.CassandraShortColumnNameTranslator},
