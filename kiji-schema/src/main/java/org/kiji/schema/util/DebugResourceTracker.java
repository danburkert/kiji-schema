...
public final class DebugResourceTracker {
  ...
  /**
   * Returns whether the resource is registered with this debug resource tracker. This is useful for
  ...
  private static final class ReferenceTracker implements Closeable {
    ...
    /**
     * Returns whether the resource is registered with this debug resource tracker. This is mostly
   ...
   *   instance of the provided interface.
   * </p>
   *
   * <p>
   *   When the proxy is created the resource is registered with the debug resource tracker.  When
   *   the proxy is closed, the resource will be unregistered.
   * </p>
   *
   ...
   * @return A tracked proxy of the provided resource.
   */
   ...
   *
   * <p>
   *   When the proxy is closed, the resource will be unregistered from the debug resource tracker.
   * </p>
   *
