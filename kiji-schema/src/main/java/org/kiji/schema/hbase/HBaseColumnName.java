...
public final class HBaseColumnName {
  ...
  /**
   * Creates a new {@link HBaseColumnName} instance.
   *
   ...
   */
  public HBaseColumnName(final String family, final String qualifier) {
   ...
   * @deprecated HBase families are not always valid {@link String}s.
   */
